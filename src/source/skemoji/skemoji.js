...
import dianzan1 from '../skemoji/1dianzan.gif'
import yiwen1 from '../skemoji/1yiwen.gif'
import deyi1 from '../skemoji/1deyi.gif'
import daoqian1 from '../skemoji/1daoqian.gif'
import beici21 from '../skemoji/1beici2.gif'
import beici11 from '../skemoji/1beici.gif'
import bukey1 from '../skemoji/1bukey.gif'
import fakey1 from '../skemoji/1fakey.gif'
import songkey1 from '../skemoji/1songkey.gif'
import doge1 from '../skemoji/1doge.gif'
import huaji11 from '../skemoji/1huaji.gif'
import xiaoku1 from '../skemoji/1xiaoku.gif'
import wude1 from '../skemoji/1wude.gif'
import cahan1 from '../skemoji/1cahan.gif'
import xiale1 from '../skemoji/1xiale.gif'
...
const SONKWO_EMOJI = [first, second]
export { SONKWO_EMOJI }
